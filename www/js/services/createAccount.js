'use strict';
angular.module('starter').service('CreateAccountService', function( $rootScope ,$http, $q, $location, ConnectivityMonitor, SessionService, ErrorService) {
	

	this.createAccount= function (queryJson) {
		...
		if($rootScope.onlineStatus){
			$http({method: 'POST',
	            url:  address+proxy+"/"+version+'/authentication/register',
